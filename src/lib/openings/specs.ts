 ...
 * Home rack placement is `racks.ts` (ids only). Do not duplicate category
 * models here.
 */
export const openingSpecs = [
  ...
  },
  {
    ...
    family: "white",
    versus: "1...c5",
    blurb: "c3, then d4. Recapture with a pawn. The Sicilian doesn't get to be messy.",
    story: {
      cast: "You are a traffic cop with a c-pawn.",
      conflict: "Black wants an Open Sicilian street fight.",
      plan: "Build a classical center, kick the queen, sit a knight on c5.",
    },
    modelFromPly: 32,
    bookChunks: [
      [4, "c3 house", "c3 is the Alapin. d4 comes next."],
      [4, "Full center", "Recapture with a pawn. Don't gambit this one."],
      [6, "Castle then kick", "King in. Then tempo the queen."],
      [6, "Hunt the queen", "Nb5. She doesn't get to sit on d6."],
      [6, "c5 outpost", "Knight to c5. The c-file is yours."],
      [8, "Pile the file", "Doubled rooks. They suffer on c."],
      [4, "IQP squeeze", "Bishop aims h7. Don't donate the d-pawn."],
    ],
    pins: [
      { afterPly: 2, label: "at the c3 house…" },
      { afterPly: 6, label: "at the d4 break…" },
      { afterPly: 18, label: "at the queen hunt…" },
      { afterPly: 30, label: "at the c5 outpost…" },
      { afterPly: 40, label: "at the model IQP…" },
    ],
    storyBeats: [
      { afterPly: 2, beat: "Cast: c3. No Open Sicilian today." },
      { afterPly: 6, beat: "Conflict: d4. You take the street back." },
      { afterPly: 18, beat: "Plan: kick the queen. Then sit on c5." },
    ],
    coach: [
      { afterPly: -1, text: "c3 first. Don't Morra this." },
      { afterPly: 0, text: "e4. Same door. Different house." },
      { afterPly: 2, text: "c3. The Alapin house. d4 next." },
      { afterPly: 6, text: "d4. Recapture with a pawn. Full center." },
      { afterPly: 14, text: "cxd4. The pawn recapture is the point." },
      { afterPly: 16, text: "Nc3. Tempo. Her queen is in the draft." },
      { afterPly: 18, text: "Nb5. Hunt the queen. She doesn't sit." },
      { afterPly: 30, text: "Nc5. Outpost. The c-file is a vice." },
      { afterPly: 40, text: "Book's done. Squeeze the IQP. Play the plan." },
    ],
    traps: [
      {
        id: "nf6-wedge",
        name: "e5 wedge",
        blurb: "They hop …Nf6. Kick it. Then d4. The Alapin vs 2…Nf6.",
        san: "e4 c5 c3 Nf6 e5 Nd5 d4 cxd4 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Ng5 Bxb3 axb3 e6",
        shotPly: 4,
        coach: "e5. Wedge. The knight doesn't get to rest.",
      },
      {
        id: "queen-snatch",
        name: "Queen snatch",
        blurb: "They grab on f3 and forget the queen. Take her, then fork c7.",
        san: "e4 c5 c3 d5 exd5 Qxd5 d4 cxd4 cxd4 Nc6 Nf3 Bg4 Nc3 Bxf3 Nxd5 Bxd1 Nc7+ Kd8 Nxa8",
        shotPly: 14,
        coach: "Nxd5. They took the knight and left the queen.",
      },
      {
        id: "nf6-center",
        name: "2…Nf6 center",
        blurb: "They chip …d6 instead of sitting. Recapture, castle, IQP squeeze.",
        san: "e4 c5 c3 Nf6 e5 Nd5 d4 cxd4 cxd4 d6 Nf3 Nc6 Bc4 Nb6 Bb3 dxe5 Nxe5 Nxe5 dxe5 Qxd1+ Kxd1",
        shotPly: 8,
        coach: "cxd4. Same house. Pawn recapture. Don't gambit it.",
      },
    ],
    pillars: {
      pawnStructure: "c3 then d4. Recapture with a pawn so you keep a classical center or an IQP you actually wanted. Don't mix in a Morra c3-after-d4.",
      pieceCoordination: "Be2 or Bd3, Nc3 hitting the queen, Nb5-c5, rooks doubled on c. Bf4-g3 bites the queen's squares.",
      kingSafety: "Short castle early. Their king is usually short. Bd3 plus a rook lift is the IQP hunt, not a cheap Greek Gift unless they ask.",
      breaksAndStorms: "d4 is the first break. Nb5 hunts the queen. Nc5 sits. c-file pile. Don't shove e5 unless they played …Nf6.",
      tacticsBank: "e5 vs …Nf6, Nxd5 queen snatch if they take on f3, IQP shots on h7 once Bd3 is in.",
      attackingPlan: "Aggressive: Nb5, Nc5, pile c. Steady: IQP, extra piece activity, ending with the d-pawn. Creative: Bf4-g3 and the long diagonal if the queen lingers.",
    },
    plans: {
      steady: "Keep the IQP. Trade a pair of pieces, not all of them. Sit on c5.",
      creative: "If they grabbed on f3, the g-file opened. Don't be shy with the rook.",
      aggressive: "Nb5, Nc5, doubled rooks. Their queen is a punching bag. Then look at h7.",
    },
    depthNote: "21 moves. Alapin vs 2…d5 with the pawn recapture and Nb5 queen-hunt. 2…Nf6 (e5 wedge) lives in the trap pack. Smith-Morra is a different tile — keep 2.c3, not 2.d4.",
  },
  {
    id: "english",
    ...
    family: "white",
    versus: "1...e5",
    blurb: "c4 and e4 clamp d5. Knight to e2 so the f-pawn can run.",
    story: {
      cast: "You are a Sicilian player who stole the extra tempo.",
      conflict: "Black wants …f5 and a kingside storm.",
      plan: "Sit on d5, expand b4, open f when the knight is on e2.",
    },
    modelFromPly: 32,
    bookChunks: [
      [4, "c4 house", "The c-pawn is the hero. Don't rush d4."],
      [6, "Botvinnik clamp", "e4 plus g3. You own the hole on d5."],
      [4, "Knight to e2", "Nge2. The f-pawn needs air."],
      [6, "d5 outpost", "Nd5. Sit. They have to live with it."],
      [6, "Hold …f5", "They chip the f-pawn. You keep the clamp."],
      [6, "Queenside expand", "b4. Same as a Sicilian, one tempo up."],
      [6, "Open the f-file", "Take on f4. The knight went to e2 for this."],
    ],
    pins: [
      { afterPly: 0, label: "at the c4 house…" },
      { afterPly: 8, label: "at the Botvinnik clamp…" },
      { afterPly: 10, label: "at the e2 knight…" },
      { afterPly: 16, label: "at the d5 hole…" },
      { afterPly: 32, label: "at the f-file…" },
    ],
    storyBeats: [
      { afterPly: 8, beat: "Cast: c4 and e4. That's the clamp." },
      { afterPly: 10, beat: "Conflict: knight to e2. f4 is coming." },
      { afterPly: 16, beat: "Plan: sit on d5. Let them squirm." },
    ],
    coach: [
      { afterPly: -1, text: "c4. Flank pawn. Own d5." },
      { afterPly: 0, text: "c4. The pawn is the hero. Not d4 yet." },
      { afterPly: 4, text: "g3. Long bishop. Same house every game." },
      { afterPly: 8, text: "e4. Clamp. Don't give the hole away." },
      { afterPly: 10, text: "Nge2. So the f-pawn can breathe." },
      { afterPly: 16, text: "Nd5. Sit on the hole they donated." },
      { afterPly: 26, text: "b4. Expand. You're a tempo up." },
      { afterPly: 32, text: "Take on f4. That's why the knight went to e2." },
      { afterPly: 40, text: "Book's done. Keep the clamp. Play the plan." },
    ],
    traps: [
      {
        id: "nd5-fork",
        name: "Nd5 sit",
        blurb: "They shove …f5 too loud. Hop into d5, then the queen checks.",
        san: "c4 e5 Nc3 Nc6 g3 g6 Bg2 Bg7 e4 d6 Nge2 Nge7 d3 O-O O-O f5 Nd5 Rf7 d4 fxe4 dxe5 Nxe5 Nxe7+ Qxe7 Qd5+",
        shotPly: 16,
        coach: "Nd5. They opened the door. Sit, then check.",
      },
      {
        id: "bb4-c7",
        name: "…Bb4 c7 hit",
        blurb: "They pin without a house. Nd5 eyes c7. That's the tax.",
        san: "c4 e5 Nc3 Nf6 g3 Bb4 Nd5 Nxd5 cxd5 O-O Bg2 d6 e3 f5 Ne2 Nd7 O-O",
        shotPly: 6,
        coach: "Nd5. c7 is loose. The pin isn't free.",
      },
      {
        id: "early-d5",
        name: "…d5 grab",
        blurb: "They open the center. Take, fianchetto, pressure the leftover knight.",
        san: "c4 e5 Nc3 Nf6 g3 d5 cxd5 Nxd5 Bg2 Nb6 Nf3 Nc6 O-O Be7 d3 O-O Be3 Be6 Rc1",
        shotPly: 6,
        coach: "cxd5. They opened it. The g2 bishop earns its keep.",
      },
    ],
    pillars: {
      pawnStructure: "Botvinnik clamp: pawns on c4 and e4, hole on d5. Don't play d4 and hand the hole back unless the pieces are ready.",
      pieceCoordination: "Bg2, Nge2 (not Nf3), Nd5, Be3, Qd2. Rooks on c and f after the f-pawn moves.",
      kingSafety: "Short castle behind the fianchetto. Their …f5 storm is the danger — keep d5 occupied so they never get a free kingside.",
      breaksAndStorms: "b4 is the queenside expand. f4 is the point of Nge2. d4 only after the clamp is built.",
      tacticsBank: "Nd5 vs a loose …f5, Nd5 vs …Bb4 hitting c7, cxd5 vs an early …d5.",
      attackingPlan: "Aggressive: f4 and the f-file. Steady: sit on d5, squeeze. Creative: b4-b5 and the c-file, Sicilian-up-a-tempo.",
    },
    plans: {
      steady: "Keep the clamp. Trade the right knight. Leave them the bad bishop.",
      creative: "b4-b5 and a rook on c. You're playing their Sicilian with an extra move.",
      aggressive: "Open f. The knight went to e2 for this. Don't put it on f3 and wonder why f4 is illegal.",
    },
    depthNote: "21 moves. Botvinnik English vs 1…e5 (c4, e4, Nge2, Nd5). Symmetrical 1…c5 and Four Knights are Phase-2. Don't put the knight on f3 — that blocks the f-pawn.",
  },
  {
    id: "caro-kann",
    name: "Caro-Kann",
    ...
    family: "black-e4",
    versus: "1.e4 Advance",
    blurb: "…c6 wall. Bishop outside. Then …c5 chips the head of e5.",
    story: {
      cast: "You are a wall with a bishop that refused jail.",
      conflict: "White wants to bury your light bishop and storm the king.",
      plan: "Bishop out, …c5, hop …Nf5, sit a knight on c4.",
    },
    modelFromPly: 32,
    bookChunks: [
      [6, "Caro wall", "…c6 then …d5. Bishop comes out before …e6."],
      [4, "Short shell", "They develop quiet. You still chip …c5."],
      [6, "Chip the head", "…c5 hits d4. The e5 pawn is the problem."],
      [6, "Nf5 hop", "The hole on f5. Pin, then hop."],
      [6, "Castle the wall", "King in. Don't donate h7."],
      [6, "c4 outpost", "Knight to c4. The c-file is your yawn."],
      [4, "Trade the bind", "If they offer the bishop, take on your terms."],
    ],
    pins: [
      { afterPly: 1, label: "at the Caro wall…" },
      { afterPly: 5, label: "at the free bishop…" },
      { afterPly: 9, label: "at the c5 chip…" },
      { afterPly: 19, label: "at the f5 hop…" },
      { afterPly: 35, label: "at the c4 outpost…" },
    ],
    storyBeats: [
      { afterPly: 5, beat: "Cast: bishop outside. That's the Caro." },
      { afterPly: 9, beat: "Conflict: …c5. Chip the head of e5." },
      { afterPly: 19, beat: "Plan: hop f5, then park on c4." },
    ],
    coach: [
      { afterPly: -1, text: "Caro wall. Bishop out first." },
      { afterPly: 1, text: "…c6. The wall. Not a French jail." },
      { afterPly: 5, text: "…Bf5. Bishop outside. That's the whole opening." },
      { afterPly: 7, text: "…e6 now. The bishop already breathed." },
      { afterPly: 9, text: "…c5. Chip the head. e5 is the problem." },
      { afterPly: 19, text: "…Nf5. Sit on the hole they left." },
      { afterPly: 25, text: "Castle. Then the c-file. Don't get cute." },
      { afterPly: 35, text: "…Nc4. Outpost. That's the yawn." },
      { afterPly: 39, text: "Book's done. Keep the wall. Play the plan." },
    ],
    traps: [
      {
        id: "bd3-help",
        name: "Bd3 helper",
        blurb: "They 'develop' Bd3. Take it. You just solved the bishop.",
        san: "e4 c6 d4 d5 e5 Bf5 Bd3 Bxd3 Qxd3 e6 Nf3 c5 c3 Nc6 O-O cxd4 cxd4 Nge7 Nc3 Nf5",
        shotPly: 6,
        coach: "Take on d3. They helped. Your bishop problem is gone.",
      },
      {
        id: "vs-fantasy",
        name: "vs Fantasy",
        blurb: "They play 3.f3. Hit …e5 and develop. Don't freeze.",
        san: "e4 c6 d4 d5 f3 dxe4 fxe4 e5 Nf3 Be6 c3 Nf6 Bd3 Nbd7 O-O Bd6",
        shotPly: 8,
        coach: "…e5. Hit the center they opened. Don't panic about f3.",
      },
      {
        id: "vs-panov",
        name: "vs Panov",
        blurb: "They take on d5 and play c4. Castle, sit on d5, play vs the IQP.",
        san: "e4 c6 d4 d5 exd5 cxd5 c4 Nf6 Nc3 e6 Nf3 Be7 cxd5 Nxd5 Bd3 O-O O-O Nc6 Re1",
        shotPly: 12,
        coach: "…Nxd5. IQP for them. You castle and sit on the blockader.",
      },
    ],
    pillars: {
      pawnStructure: "…c6/…d5 wall. After …c5 the e5 pawn can become a target. If they take on f5, the e-file and the c4 hole are yours.",
      pieceCoordination: "Bf5 first, then …e6, …c5, …Nge7-f5, …Nc6-a5-c4. Queen on d7, rooks on c.",
      kingSafety: "Short castle after …Be7. Don't castle into Bd3+Q without a defender. …h6 is air vs h3-g4 ideas.",
      breaksAndStorms: "…c5 is the break. …Nf5 is the hop. …Nc4 is the sit. Don't invent …g5.",
      tacticsBank: "Bd3 helper, …e5 vs Fantasy, blockader vs Panov IQP.",
      attackingPlan: "Aggressive: …c5 and the c-file. Steady: trade, win the ending the Caro is famous for. Creative: …Nf5 and a knight on c4 forever.",
    },
    plans: {
      steady: "Trade a pair. Keep the bishop pair or the c4 hole. Endings are the Caro's joke.",
      creative: "If they took on f5, use the e-file and the c4 outpost. Dual wing.",
      aggressive: "Pile the c-file. Knight on c4. If their king is still in the center, open it.",
    },
    depthNote: "21 moves. Advance Short (3.e5 Bf5 4.Nf3 e6 5.Be2 c5) is the spine — the club try you actually face. Fantasy and Panov live in the trap pack. Classical 3.Nc3 is Phase-2.",
  },
  {
    id: "queens-gambit",
    name: "Queen's Gambit",
    shortName: "QG Exchange",
    side: "white",
    family: "white",
    versus: "1...d5",
    blurb: "Take on d5. Rook behind the b-pawn. Wreck c6. That's the minority.",
    story: {
      cast: "You are a wrecking crew with one extra queenside pawn.",
      conflict: "Black wants a solid …c6 wall and a safe king.",
      plan: "Rab1, b4-b5, leave them a backward c-pawn. Then sit Ne5.",
    },
    modelFromPly: 32,
    bookChunks: [
      [4, "Offer the wing", "c4. You don't cling to the c-pawn."],
      [4, "Exchange the center", "Take on d5. Now the minority is legal."],
      [6, "Pin and house", "Bg5, e3, Bd3. Same pieces every game."],
      [6, "Rook behind b", "Rab1. That's the minority tell."],
      [6, "b4 anyway", "They played …a5. You still expand."],
      [6, "Wreck c6", "b5. Isolate or backward. Their wall cracks."],
      [8, "Ne5 sit", "Outpost. Trade the right minors. Ending time."],
    ],
    pins: [
      { afterPly: 2, label: "at the c4 offer…" },
      { afterPly: 6, label: "at the exchange…" },
      { afterPly: 20, label: "at the minority rook…" },
      { afterPly: 24, label: "at the b4 expand…" },
      { afterPly: 32, label: "at the c6 wreck…" },
    ],
    storyBeats: [
      { afterPly: 6, beat: "Cast: exchange. Now you have a minority." },
      { afterPly: 20, beat: "Conflict: rook behind b. They feel b4 coming." },
      { afterPly: 24, beat: "Plan: b4-b5. Wreck the wall." },
    ],
    coach: [
      { afterPly: -1, text: "Offer c4. Then take. Then minority." },
      { afterPly: 2, text: "c4. Wing pawn. You want the center." },
      { afterPly: 6, text: "cxd5. Exchange. The minority starts here." },
      { afterPly: 8, text: "Bg5. Pin. Don't let the knight breathe." },
      { afterPly: 20, text: "Rab1. Rook behind the b-pawn. That's the tell." },
      { afterPly: 24, text: "b4. They played …a5. Expand anyway." },
      { afterPly: 30, text: "b5. Crack c6. That's the wreck." },
      { afterPly: 34, text: "Ne5. Sit. The backward pawn is a patient." },
      { afterPly: 40, text: "Book's done. Keep the wreck. Play the plan." },
    ],
    traps: [
      {
        id: "early-bf5",
        name: "…Bf5 too soon",
        blurb: "They develop the bishop before the house is ready. Qb3 hits b7 and d5.",
        san: "d4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 c6 e3 Bf5 Qb3 Qb6 Qxb6 axb6 Bxf6 gxf6",
        shotPly: 12,
        coach: "Qb3. Two weaknesses. That's why …Bf5 was early.",
      },
      {
        id: "tarrasch-iqp",
        name: "Tarrasch IQP",
        blurb: "They break …c5 and accept an IQP. Fianchetto, castle, sit on d4.",
        san: "d4 d5 c4 e6 Nc3 c5 cxd5 exd5 Nf3 Nc6 g3 Nf6 Bg2 Be7 O-O O-O dxc5 Bxc5",
        shotPly: 4,
        coach: "They opened …c5. Take, then play vs the IQP. Don't panic.",
      },
      {
        id: "cambridge",
        name: "Cambridge …Qa5",
        blurb: "They pin and check with the queen. Nd2 covers. Then Be2 and you still expand.",
        san: "d4 d5 c4 e6 Nc3 Nf6 Bg5 Nbd7 e3 c6 Nf3 Qa5 Nd2 Bb4 Qc2 O-O Be2 e5",
        shotPly: 12,
        coach: "Nd2. Cover c3. The queen check isn't a crisis.",
      },
    ],
    pillars: {
      pawnStructure: "Exchange: you have a- and b-pawns vs their a/b/c. b4-b5 wrecks c6 — backward or isolated. Don't rush e4 unless the minors are ready.",
      pieceCoordination: "Bg5, Bd3, Qc2, Nf3, Rab1. After b5, Ne5 sits. Rooks belong on b and c.",
      kingSafety: "Short castle. Their king is short. The attack is the queenside wreck, not a kingside fantasy — unless they castle into Bd3.",
      breaksAndStorms: "b4-b5 is the storm. e4 is the other break, later. Don't mix both until the pieces agree.",
      tacticsBank: "Qb3 vs early …Bf5, IQP vs Tarrasch …c5, Nd2 vs Cambridge …Qa5.",
      attackingPlan: "Aggressive: b5, Ne5, pile c. Steady: wreck, trade, win the ending. Creative: if they take on b4, the a-file is a second front.",
    },
    plans: {
      steady: "Leave them the backward c-pawn. Trade into a good knight vs bad bishop.",
      creative: "If they opened the a-file, use it. Dual files vs the wreck.",
      aggressive: "b5 now. Ne5. Double on c. Their wall is the target, not their king.",
    },
    depthNote: "21 moves. QGD Exchange minority (cxd5, Rab1, b4-b5) is the club package — one plan, not an Orthodox encyclopedia. Nge2+e4 and the Orthodox …dxc4 main are Phase-2.",
  },
  {
    id: "slav",
    name: "Slav Defense",
    ...
    side: "black",
    family: "black-d4",
    versus: "1.d4 mainline",
    blurb: "…c6 wall. Take on c4, bishop out, then …e6. Don't mix a Semi.",
    story: {
      cast: "You are a wall whose bishop refused to sit in jail.",
      conflict: "White wants e4-e5 and to bury the light bishop.",
      plan: "Hold c4 or give it back developed, pin Bb4, hop …Nd5 when they shove e5.",
    },
    modelFromPly: 32,
    bookChunks: [
      [4, "Slav wall", "…c6, not …e6. That's Slav, not Semi."],
      [6, "Take then bishop", "…dxc4, then …Bf5. Bishop breathes first."],
      [6, "Pin the knight", "…Bb4. e4 is harder for them now."],
      [6, "Castle the wall", "King in. Bishop tucks to g6-h5."],
      [6, "Nd5 hole", "They shove e5. You hop into the hole."],
      [6, "c-file sit", "Rook to c. Knight recycles to c6."],
      [4, "Air vs h-pawn", "…h6, bishop tucks. Don't get trapped."],
    ],
    pins: [
      { afterPly: 3, label: "at the Slav wall…" },
      { afterPly: 7, label: "at taking c4…" },
      { afterPly: 9, label: "at the free bishop…" },
      { afterPly: 13, label: "at the Bb4 pin…" },
      { afterPly: 23, label: "at the Nd5 hole…" },
    ],
    storyBeats: [
      { afterPly: 3, beat: "Cast: …c6. Wall. Not a Semi." },
      { afterPly: 9, beat: "Conflict: bishop outside. That's the Slav." },
      { afterPly: 13, beat: "Plan: pin, castle, hop Nd5 if they shove." },
    ],
    coach: [
      { afterPly: -1, text: "Slav wall. Bishop out before …e6." },
      { afterPly: 3, text: "…c6. The wall. Don't play Semi here." },
      { afterPly: 7, text: "…dxc4. Take. Then get the bishop out." },
      { afterPly: 9, text: "…Bf5. Bishop outside. That's the whole opening." },
      { afterPly: 11, text: "…e6 now. The bishop already breathed." },
      { afterPly: 13, text: "…Bb4. Pin. e4 costs them a story." },
      { afterPly: 21, text: "…Bh5. Keep the pin. Don't jail the bishop." },
      { afterPly: 23, text: "…Nd5. They shoved e5. Sit in the hole." },
      { afterPly: 39, text: "Book's done. Keep the wall. Play the plan." },
    ],
    traps: [
      {
        id: "exchange-qb3",
        name: "Exchange Qb3",
        blurb: "They take on d5 and Qb3 the bishop. …Na5 hits the queen. Tempo.",
        san: "d4 d5 c4 c6 Nf3 Nf6 cxd5 cxd5 Nc3 Nc6 Bf4 Bf5 Qb3 Na5 Qa4+ Bd7 Qd1 e6",
        shotPly: 12,
        coach: "…Na5. Hit the queen. That's why Qb3 isn't free.",
      },
      {
        id: "hold-c4",
        name: "Hold c4",
        blurb: "They don't play a4. …b5 keeps the pawn. Make them prove it.",
        san: "d4 d5 c4 c6 Nf3 Nf6 Nc3 dxc4 e3 b5 a4 e6 axb5 cxb5 b3 Bb4 Bd2 Bxc3 Bxc3 a5",
        shotPly: 8,
        coach: "…b5. Hold the pawn. a4 is the tax they skipped.",
      },
      {
        id: "geller",
        name: "Geller e4",
        blurb: "They gambit e4 without a4. Take on e4. The extra pawn is real.",
        san: "d4 d5 c4 c6 Nf3 Nf6 Nc3 dxc4 e4 b5 a4 b4 Ne2 Nxe4 Ng3 Nf6 Bxc4",
        shotPly: 12,
        coach: "…Nxe4. They opened the center. Cash the pawn.",
      },
    ],
    pillars: {
      pawnStructure: "…c6 wall. After …dxc4 you either hold with …b5 or give it back developed. Don't play …e6 before the bishop is out — that's a Semi-Slav, a different house.",
      pieceCoordination: "Bf5-g6-h5, Bb4, Nbd7-b8-c6, Nd5 vs e5. Rooks on c. Queen stays flexible on d8-b6.",
      kingSafety: "Short castle after the pin. Their h-pawn storm is the danger — …h6 and Bh7 tuck. Don't get the bishop trapped on h5.",
      breaksAndStorms: "…c5 later if the files agree. …e5 is rare here. The hop …Nd5 is the answer to their e4-e5 shove.",
      tacticsBank: "…Na5 vs Exchange Qb3, …b5 vs no a4, …Nxe4 vs Geller.",
      attackingPlan: "Aggressive: hold c4 and expand …b5. Steady: give c4 back, pin, sit on d5. Creative: the c-file and a recycled knight on c6.",
    },
    plans: {
      steady: "Give c4 back. Keep the bishop pair. Sit on d5. Endings are fine.",
      creative: "If they skipped a4, hold the pawn with …b5 and make a passed a-pawn.",
      aggressive: "Pin, hop Nd5, pile c. If their king is still in the center, open it.",
    },
    depthNote: "21 moves. Classical Slav (…dxc4, 5.a4 Bf5, bishop out before …e6). Semi-Slav …e6 is a different tile later — not mixed into this spine. Exchange Qb3 and Geller e4 live in the trap pack.",
  },
] as OpeningSpec[];
